...
public class CustomDialog {
    ...
    public void showConfirm(String content, boolean isSuccess) {
        ...
        // set Background
        imgBg.setImageResource(isSuccess ? R.drawable.ic_success2: R.drawable.ic_fail2);
        btnOk.setBackgroundResource(isSuccess ? R.drawable.bg_button_ok : R.drawable.bg_button_exit);
        btnOk.setText(isSuccess ?"Ok":"Exit");
